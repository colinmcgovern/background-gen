...
//Goal: create perlin noise fire version of image DONE
//Goal: animated rising fire. requires gif output.
//Goal: Make computationally expensive enough to justify pthreading
//Goal: Once all above goals are complete. Organize and save to github

//Once complete move onto camo generation
...
void process_png_file() {
    ...
    cout << largest_perlin << " " << smallest_perlin << endl; //del
